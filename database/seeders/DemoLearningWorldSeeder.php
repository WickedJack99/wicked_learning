...
class DemoLearningWorldSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $map = LearningMap::query()->create([
            ...
            'background_config' => [
                'dark' => [
                    'imageUrl' => '/images/themes/fantasy-world-map-background.png',
        ...
        $signalGate = LearningNode::query()->create([
            ...
            'visual_config' => [
                ...
                'dark' => [
                    ...
                    'imageUrl' => '/images/nodes/fantasy-hex-crystal-grove.png',
                ],
                'light' => [
                    'tileColor' => '#d5f5f0',
    ...
    private function npcVisualConfig(): array
    {
        return [
            ...
            'npcImageDark' => '/images/characters/npc-mira-dark.png',
            'npcImageLight' => '/images/characters/npc-mira-light.png',
            'npcX' => 72,
            'npcY' => 46,
        ...
        $fieldNotes = LearningNode::query()->create([
            ...
            'visual_config' => [
                ...
                'dark' => [
                    ...
                    'imageUrl' => '/images/nodes/fantasy-hex-library.png',
                ],
                'light' => [
                    'tileColor' => '#dbeafe',
        ...
        LearningNode::query()->create([
            ...
            'visual_config' => [
                ...
                'dark' => [
                    ...
                    'imageUrl' => '/images/nodes/fantasy-hex-castle.png',
                ],
                'light' => [
                    'tileColor' => '#ede9fe',
    ...
    private function routeImageExamples(LearningNode $node): array
    {
        return match ($node->slug) {
            'portal-foundation' => [
                ...
                'image_dark' => '/images/portals/portal-swirl.png',
                'image_light' => '/images/portals/portal-swirl.png',
            ],
            'signal-gate' => [
