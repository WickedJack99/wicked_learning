...
class DemoLearningWorldSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DialogueStage::query()->create([
            ...
            'portrait_url' => '/images/themes/mentor-calm.png',
        ...
        DialogueStage::query()->create([
            ...
            'portrait_url' => '/images/themes/mentor-hint.png',
        ...
        DialogueStage::query()->create([
            ...
            'portrait_url' => '/images/themes/mentor-alert.png',
    ...
    private function npcVisualConfig(): array
    {
        return [
            ...
            'npcImageDark' => '/images/themes/npc-mira-dark.png',
            'npcImageLight' => '/images/themes/npc-mira-light.png',
            'npcX' => 72,
            'npcY' => 46,
