...
- A question may optionally collect a plain-language starting sense (`exploring`, `leaning`, or `settled`). It is kept with the private answer for later reflection and calibration, not used as a score or star-map signal.
