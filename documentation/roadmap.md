...
replacement. Start with an inspectable rule-based scheduler and a finite due
queue. Adaptive or AI scheduling should wait until the baseline is measurable
and understandable.
