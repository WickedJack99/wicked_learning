...
export function NodeDetailDrawer({
    ...
    return (
        <aside
            className={cn(
                'absolute inset-x-0 top-28 bottom-0 z-50 w-full touch-pan-y border-l border-slate-200 bg-white text-slate-950 shadow-2xl transition-transform duration-300 ease-out sm:top-16 md:left-auto md:max-w-[420px] dark:border-white/10 dark:bg-[#111820] dark:text-slate-100',
