        ...
        <div className="grid h-full min-h-0 gap-4 overflow-hidden lg:grid-cols-[18rem_minmax(0,1fr)]">
            ...
            <section className="flex min-h-0 flex-col overflow-hidden rounded-lg border border-[var(--settings-border-color)]">
                ...
                <div className="flex min-h-0 flex-1 flex-col overflow-hidden p-4">
                    ...
                    <div className="mt-5 flex min-h-0 flex-1 flex-col overflow-hidden rounded-lg border border-[var(--settings-border-color)]">
                        <div className="grid shrink-0 grid-cols-[minmax(12rem,1fr)_18rem_14rem] bg-[var(--settings-active-background)] px-4 py-3 text-xs font-medium tracking-[0.14em] text-[var(--settings-muted-text)] uppercase">
                            <span>
