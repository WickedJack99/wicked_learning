...
export function activityFormFromActivity(
    ...
    return {
        ...
        feedback_independent_check_feedback: feedbackGuidanceField(
            activity.config.feedbackGuidance,
            'independentCheckFeedback',
        ),
        ...
        time_guide_minutes: stringConfig(activity.config.timeGuideMinutes),
        ...
        message_response_prompt: stringConfig(
            activity.config.messageResponsePrompt,
        ),
        ...
        shared_task_project_deliverable: stringConfig(
            activity.config.projectDeliverable,
        ),
