---
name: wicked-learning-design-review
description: Use when reviewing Wicked Learning concepts, activity flows, competence measurement, AI feedback, learner motivation, journal/reflection design, or admin authoring workflows through Self-Determination Theory and intrinsic-motivation principles. Helps keep features autonomy-supportive, competence-supportive, generic across domains, and free from points, streaks, leaderboards, or reward-chasing.
---
...
Prefer practical recommendations that can be implemented next. Separate product concerns from implementation concerns.
