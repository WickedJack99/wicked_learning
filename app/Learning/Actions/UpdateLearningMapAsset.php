...
class UpdateLearningMapAsset
{
    ...
    public function handle(
        ...
        return DB::transaction(function () use ($asset, $data, $user): LearningMapAsset {
            if ($user instanceof User) {
                $this->recordVersion($user, $asset);
            }
    ...
    private function recordVersion(User $user, LearningMapAsset $asset): void
    {
