...
class LoadLearnerRecallItems
{
    ...
    /**
     * @return list<array{activityHref: string, activityId: int, activityTitle: string, isDue: bool, lastReviewedAt: string|null, mapTitle: string, nextReviewAt: string|null, nodeHref: string, nodeTitle: string, prompt: string, questionId: int, reviewCount: int}>
     */
