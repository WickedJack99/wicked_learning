...
class GenerateAiContentPlan
{
    ...
    private function prompt(array $brief, array $context): string
    {
        return implode("\n\n", [
            ...
            'If selected source records are provided, use them as optional factual grounding. Preserve their titles, URLs, publishers, anchors and excerpts accurately; do not invent citations or imply that an unselected source supports the draft. For each Activity, put the IDs of only directly supporting selected records in sourceRecordIds; use an empty array when no selected record directly supports that Activity.',
