...
class ReviewLearningActivity
{
    ...
    private function prompt(array $context): string
    {
        return implode("\n\n", [
            ...
            'Inspect the optional completion choice context. If it is present, assess whether it gives a clear reason to choose among the three bounded directions after completion. Do not recommend more choices or pressure to choose one.',
